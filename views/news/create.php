...
<?= $form->field($model, 'title')->textarea(['placeholder' => 'A loud header', 'value' => 'title-value'])->hint('You can specify where to insert uploaded file(s) using the next markup: <strong>[filename.extension]</strong> example: <strong>[cat.png]</strong> You can display one file several times.') ?>
